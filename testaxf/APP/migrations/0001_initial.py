# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-05-08 03:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('longname1', models.CharField(default=0, max_length=200)),
                ...
                ('longname2', models.CharField(default=0, max_length=200)),
                ...
                ('longname3', models.CharField(default=0, max_length=200)),
        ...
        migrations.CreateModel(
            name='UserModelTicket',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ticket', models.CharField(max_length=200, null=True)),
                ('out_time', models.DateTimeField(null=True)),
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='APP.UserModel')),
            ],
            options={
                'db_table': 'axf_ticket',
            },
